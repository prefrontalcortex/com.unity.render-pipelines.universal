...
namespace UnityEngine.Rendering.Universal
{
    ...
    internal class ScreenSpaceAmbientOcclusion : ScriptableRendererFeature
    {
        ...
        {
            // Properties
            private bool isRendererDeferred => false;//m_Renderer != null && m_Renderer is UniversalRenderer && ((UniversalRenderer)m_Renderer).renderingMode == RenderingMode.Deferred;
            ...
            public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
            {
                ...
                switch (m_CurrentSettings.Source)
                {
                    case ScreenSpaceAmbientOcclusionSettings.DepthSource.DepthNormals:
                        ...
                        CoreUtils.SetKeyword(m_Material, k_SourceGBufferKeyword, false);
                        break;
                    default:
